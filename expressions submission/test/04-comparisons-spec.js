...
describe("04 - Comparisons", () => {
  describe("1. isHelloStr1 is true if str1 is strictly equal to 'hello'", () => {
    it("if str1 = 'hello', isHelloStr1 should be true", () => {
      ...
      if (!("isHelloStr1" in comparisons)) throw new ReferenceError("isHelloStr1 is not defined");
      if (!("str1" in comparisons)) throw new ReferenceError("str1 is not defined");
  ...
  describe("2. isHelloStr2 is true if str2 is strictly equal to 'hello'", () => {
    it("if str2 = 'world', isHelloStr2 should be false", () => {
      ...
      if (!("isHelloStr2" in comparisons)) throw new ReferenceError("isHelloStr2 is not defined");
      if (!("str2" in comparisons)) throw new ReferenceError("str2 is not defined");
  ...
  describe("3. isNotHelloStr3 is false if str3 is strictly equal to 'hello'", () => {
    it("if str3 = 'moon', isNotHelloStr3 should be true", () => {
      ...
      if (!("isNotHelloStr3" in comparisons)) throw new ReferenceError("isNotHelloStr3 is not defined");
      if (!("str3" in comparisons)) throw new ReferenceError("str3 is not defined");
  ...
  describe("4. isStrictSameNum is true if num1 is strictly equal to 10", () => {
    it("if num1 = 10, isStrictSameNum should be true", () => {
      ...
      if (!("isStrictSameNum" in comparisons)) throw new ReferenceError("isStrictSameNum is not defined");
      if (!("num1" in comparisons)) throw new ReferenceError("num1 is not defined");
  ...
  describe("5. isStrictDiffNum is false if num2 is strictly equal to 7", () => {
    it("if num2 = 15, isStrictDiffNum should be true", () => {
      ...
      if (!("isStrictDiffNum" in comparisons)) throw new ReferenceError("isStrictDiffNum is not defined");
      if (!("num2" in comparisons)) throw new ReferenceError("num2 is not defined");
  ...
  describe("6. isLooselySameNum is false if num3 is loosely equal to '20'", () => {
    it("if num3 = 20, isLooselySameNum should be true", () => {
      ...
      if (!("isLooselySameNum" in comparisons)) throw new ReferenceError("isLooselySameNum is not defined");
      if (!("num3" in comparisons)) throw new ReferenceError("num3 is not defined");
  ...
  describe("7. isGreater is true if num4 is greater than 10", () => {
    it("if num4 = 12, isGreater should be true", () => {
      ...
      if (!("isGreater" in comparisons)) throw new ReferenceError("isGreater is not defined");
      if (!("num4" in comparisons)) throw new ReferenceError("num4 is not defined");
  ...
  describe("8. isLess is true if num5 is less than the sum of num6 and 4", () => {
    it("if num5 = 3 and num6 = 2, isLess should be true", () => {
      ...
      if (!("isLess" in comparisons)) throw new ReferenceError("isLess is not defined");
      if (!("num5" in comparisons)) throw new ReferenceError("num5 is not defined");
      if (!("num6" in comparisons)) throw new ReferenceError("num6 is not defined");
  ...
  describe("9. isGreaterOrEqual is true if num7 is greater than or equal to the sum of num8 and the number -2", () => {
    it("if num7 = 9 and num8 = 11, isGreaterOrEqual should be true", () => {
      ...
      if (!("isGreaterOrEqual" in comparisons)) throw new ReferenceError("isGreaterOrEqual is not defined");
      if (!("num7" in comparisons)) throw new ReferenceError("num7 is not defined");
      if (!("num8" in comparisons)) throw new ReferenceError("num8 is not defined");
  ...
  describe("10. isInRange is true if num9 is in between the inclusive range of 8 and 10", () => {
    it("if num9 = 10, isInRange should be true", () => {
      ...
      if (!("isInRange" in comparisons)) throw new ReferenceError("isInRange is not defined");
      if (!("num9" in comparisons)) throw new ReferenceError("num9 is not defined");
  ...
  describe("11. isInExclusiveRange is true if num10 falls inside the exclusive range of 8 to 10", () => {
    it("if num10 = 9, isInExclusiveRange should be true", () => {
      ...
      if (!("isInExclusiveRange" in comparisons)) throw new ReferenceError("isInExclusiveRange is not defined");
      if (!("num10" in comparisons)) throw new ReferenceError("num10 is not defined");
  ...
  describe("12. isOutOfRange is false if num11 is in in between the inclusive range of 50 and 80", () => {
    it("if num11 = 91, isOutOfRange should be true", () => {
      ...
      if (!("isOutOfRange" in comparisons)) throw new ReferenceError("isOutOfRange is not defined");
      if (!("num11" in comparisons)) throw new ReferenceError("num11 is not defined");
