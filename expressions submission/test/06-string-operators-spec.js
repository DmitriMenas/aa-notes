...
describe("06 - String Operators", () => {
  describe("1. str1Length", () => {
    it("should evaluate to 12 if str1 is 'Hello World!'", () => {
      ...
      if (!("str1Length" in obj)) throw new ReferenceError("str1Length is not defined");
  ...
  describe("2. lastIndexStr2", () => {
    it("should evaluate to 2 if str2 is 'App'", () => {
      ...
      if (!("lastIndexStr2" in obj)) throw new ReferenceError("lastIndexStr2 is not defined");
  ...
  describe("3. firstCharStr3", () => {
    it("should evaluate to 'H' if str3 is 'Hello World!'", () => {
      ...
      if (!("firstCharStr3" in obj)) throw new ReferenceError("firstCharStr3 is not defined");
  ...
  describe("4. lastCharStr4", () => {
    it("should evaluate to 'p' if str4 is 'App'", () => {
      ...
      if (!("lastCharStr4" in obj)) throw new ReferenceError("lastCharStr4 is not defined");
  ...
  describe("5. indexOfP", () => {
    it("should evaluate to 1 if str5 is 'App'", () => {
      ...
      if (!("indexOfP" in obj)) throw new ReferenceError("indexOfP is not defined");
  ...
  describe("6. fifthCharStr6", () => {
    it("should evaluate to 'o' if str6 is 'Hello World!'", () => {
      ...
      if (!("fifthCharStr6" in obj)) throw new ReferenceError("fifthCharStr6 is not defined");
