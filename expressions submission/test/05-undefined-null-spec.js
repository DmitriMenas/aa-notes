...
describe("05 - Undefined and Null", () => {
  describe("1. declaredVar", () => {
    it("should have a value of undefined", () => {
      ...
      if (!("declaredVar" in obj)) throw new ReferenceError("declaredVar is not defined");
  ...
  describe("2. definedVar", () => {
    it("should have a value of 'This is a defined variable'", () => {
      const obj = formatFile();
      if (!("definedVar" in obj)) throw new ReferenceError("definedVar is not defined");
  ...
  describe("3. nullVar", () => {
    it("should have a value of null", () => {
      const obj = formatFile();
      if (!("nullVar" in obj)) throw new ReferenceError("nullVar is not defined");
  ...
  describe("4. isNull", () => {
    it("should evaluate to true if unknownVar1 is null", () => {
      ...
      if (!("unknownVar1" in obj)) throw new ReferenceError("unknownVar1 is not defined");
  ...
  describe("5. isUndefined", () => {
    it("should evaluate to true if unknownVar2 is undefined", () => {
      ...
      if (!("unknownVar2" in obj)) throw new ReferenceError("unknownVar2 is not defined");
      if (!("isUndefined" in obj)) throw new ReferenceError("isUndefined is not defined");
